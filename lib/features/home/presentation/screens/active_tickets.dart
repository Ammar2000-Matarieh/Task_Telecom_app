...
import 'package:telecom_support_app/features/home/presentation/screens/tickets_detials.dart';
...
class _ActiveTicketsState extends State<ActiveTickets> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Active Tickets"), centerTitle: true),
